...
namespace HMapperTests
{
    ...
    public class Tests
    {
        ...
        {
            // We have SimpleClass that is mapped to 2 target types.
            // The first one is used (could be SimpleClass or SimpleClass2).
            Run(NonGenericSet.Create(1), x => new DTO.NonGenericSet(x));
        }
